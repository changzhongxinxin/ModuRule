...
async function fetchChilledmelonDays() {
    // 优先从参数/环境变量读取 cmToken，没有则从持久化存储 $persistentStore 读取
...
function makeNormalWidget(alerts, normal, totalCount, cmDays) {
    ...
    // 构建顶部标题栏子元素：[图标] [状态标题] [弹性占位Spacer] [瓜天数(如有)] [台数]
